#This code file runs the testing on the external test dataset CRC-VAL-HE-7K. Here, the different trained models can be loaded and tested. Adjust the "XXX" for proper code usage. This file requires the data from the DataLoader_7K.py file as well as the save model parameters from the Train_100K.py file.
