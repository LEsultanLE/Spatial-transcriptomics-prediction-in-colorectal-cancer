...
t_acc, df_cm, df_cm_norm, df_cm_prec = test(get_model(pretrained_model), test_set, batch_size, colondata.classes)
...
#Saving Confusion-Matrices as .csv files
#------------------------------------------------------------------------------
...
rec, prec, f1 = get_metrics(df_cm, colondata.classes)
