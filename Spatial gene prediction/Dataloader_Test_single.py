...
#pre-processed AnnData objects from Preprocessing_Tiling.py for testing. Here, no data augmentations are used. Adjust the "XXX" for proper code usage.
...
sample = "p008" #This was the name of one of the samples used in our project as testing samples. Adjust to your needs.
