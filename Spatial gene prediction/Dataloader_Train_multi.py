...
#Apply training and validation transforms
#------------------------------------------------------------------------------
class Subset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        a, g1, g2, g3, g4, e = self.subset[index] #adapt to the amount of genes that are predicted simultaneously
        if self.transform:
            a = self.transform(a)
        return (a, g1, g2, g3, g4, e) #adapt to the amount of genes that are predicted simultaneously
...
train_transforms = transforms.RandomApply([transforms.RandomRotation(degrees =
                                            ...
                                            transforms.RandomAdjustSharpness(
                                                sharpness_factor = 2, p = 0.75)], p=0.5)
